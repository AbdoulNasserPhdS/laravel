                ...
                <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
                    ...
                    <div class="grid gap-12 lg:grid-cols-2">
                      ...
                      <div class="p-1 rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
                        <img src="{{ str_contains($post->image, 'posts/') ? asset('/storage/'. $post->image) : $post->image }}" alt="art cover" loading="lazy" width="1000" height="667" class="h-56 sm:h-full w-full sm:w-5/12 object-cover object-top rounded-lg transition duration-500 group-hover:rounded-xl">
                        <div class="sm:w-7/12 pl-0 p-5">
                          <div class="space-y-2">
                            ...
                            <a href="{{ route('show',$post) }}" class="block w-max text-cyan-600">Read more</a>
                          </div>
                        </div>
                      </div>
                    @endforeach
